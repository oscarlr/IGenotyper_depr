...
def get_assemble_regions(phased_regions_bed,regions):
...
def get_regions_to_assemble(phased_regions,sv_regions,non_sv_regions):
    ...
    sv_regions_with_haps = get_assemble_regions(phased_regions_bed,sv_regions)
    non_sv_regions_with_haps = get_assemble_regions(phased_regions_bed,non_sv_regions)
